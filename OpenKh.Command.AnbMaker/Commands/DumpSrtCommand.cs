                ...
                )
                {
                    ...
                    foreach (var fCurve in curvesInput.FCurves)
                    {
                        Action<PerMotion, float> setter = fCurve.ChannelValue switch
                        {
                            ...
                            Channel.ROTATATION_X => (it, value) => it.RotationX = consumeRadians(value),
                            Channel.ROTATATION_Y => (it, value) => it.RotationY = consumeRadians(value),
                            Channel.ROTATATION_Z => (it, value) => it.RotationZ = consumeRadians(value),
