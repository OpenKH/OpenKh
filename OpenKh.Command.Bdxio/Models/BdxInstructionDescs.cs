...
namespace OpenKh.Command.Bdxio.Models
{
    public class BdxInstructionDescs
    {
        ...
        private static readonly BdxInstructionDesc[] _descs = new[]
        {
            ...
            new BdxInstructionDesc { Code = 0x0005, CodeMask = 0xFFFF, Name = "cfti", CodeSize = 1 },
            ...
            new BdxInstructionDesc { Code = 0x0055, CodeMask = 0xFFFF, Name = "citf", CodeSize = 1 },
            ...
            new BdxInstructionDesc { Code = 0x0047, CodeMask = 0xFFCF, Name = "jnz", IsJump = true, IsJumpConditional = true, CodeSize = 2, Args = new[] { new Arg { Name = "imm16", Type = ArgType.Imm16, IsRelative = true } } },
            new BdxInstructionDesc { Code = 0x0087, CodeMask = 0xFFCF, Name = "jz", IsJump = true, IsJumpConditional = true, CodeSize = 2, Args = new[] { new Arg { Name = "imm16", Type = ArgType.Imm16, IsRelative = true } } },
