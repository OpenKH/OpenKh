...
namespace OpenKh.Command.Bdxio.Models
{
    public class BdxInstructionDescs
    {
        ...
        private static readonly BdxInstructionDesc[] _descs = new[]
        {
            ...
            new BdxInstructionDesc { Code = 0x00A0, CodeMask = 0xFFFF, Name = "push.tp", CodeSize = 2, Args = new[] { new Arg { Name = "imm16", Type = ArgType.Imm16 } }, OldNames = new[] { "pushFromPSpVal" } },
            ...
            new BdxInstructionDesc { Code = 0x00B0, CodeMask = 0xFFFF, Name = "push.f.tp", CodeSize = 2, Args = new[] { new Arg { Name = "imm16", Type = ArgType.Imm16 } }, OldNames = new[] { "pushFromFSpVal" } },
