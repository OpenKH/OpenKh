...
namespace OpenKh.Command.Bdxio.Models
{
    public class BdxInstructionDescs
    {
        ...
        private static readonly BdxInstructionDesc[] _descs = new[]
        {
            ...
            new BdxInstructionDesc { Code = 0x00A0, CodeMask = 0xFFFF, Name = "push.sp.add", CodeSize = 2, Args = new[] { new Arg { Name = "imm16", Type = ArgType.Imm16 } }, OldNames = new[] { "pushFromPSpVal" } },
            new BdxInstructionDesc { Code = 0x00E0, CodeMask = 0xFFFF, Name = "push.text", CodeSize = 2, Args = new[] { new Arg { Name = "imm16", Type = ArgType.Imm16, AiPos = true } }, OldNames = new[] { "pushFromPAi" } },
            new BdxInstructionDesc { Code = 0x0030, CodeMask = 0xFFFF, Name = "push.f.sp", CodeSize = 2, Args = new[] { new Arg { Name = "imm16", Type = ArgType.Imm16 } }, OldNames = new[] { "pushFromFSp" } },
            new BdxInstructionDesc { Code = 0x0070, CodeMask = 0xFFFF, Name = "push.f.wp", CodeSize = 2, Args = new[] { new Arg { Name = "imm16", Type = ArgType.Imm16, WorkPos = true } }, OldNames = new[] { "pushFromFWp" } },
            new BdxInstructionDesc { Code = 0x00B0, CodeMask = 0xFFFF, Name = "push.f.sp.add", CodeSize = 2, Args = new[] { new Arg { Name = "imm16", Type = ArgType.Imm16 } }, OldNames = new[] { "pushFromFSpVal" } },
            new BdxInstructionDesc { Code = 0x00F0, CodeMask = 0xFFFF, Name = "push.f.text", CodeSize = 2, Args = new[] { new Arg { Name = "imm16", Type = ArgType.Imm16, AiPos = true } }, OldNames = new[] { "pushFromFAi" } },
            ...
            new BdxInstructionDesc { Code = 0x0081, CodeMask = 0xFFCF, Name = "pop.tp", CodeSize = 2, Args = new[] { new Arg { Name = "imm16", Type = ArgType.Imm16 } }, OldNames = new[] { "popToSpVal" } },
            new BdxInstructionDesc { Code = 0x00C1, CodeMask = 0xFFCF, Name = "pop.text", CodeSize = 2, Args = new[] { new Arg { Name = "imm16", Type = ArgType.Imm16, AiPos = true } }, OldNames = new[] { "popToAi" } },
            ...
            new BdxInstructionDesc { Code = 0x0082, CodeMask = 0xFFCF, Name = "memcpy.tp", CodeSize = 3, Args = new[] { new Arg { Name = "imm16", Type = ArgType.Imm16 }, new Arg { Name = "imm16_2", Type = ArgType.Imm16 } }, OldNames = new[] { "memcpyToSpVal" } },
            new BdxInstructionDesc { Code = 0x00C2, CodeMask = 0xFFCF, Name = "memcpy.text", CodeSize = 3, Args = new[] { new Arg { Name = "imm16", Type = ArgType.Imm16 }, new Arg { Name = "imm16_2", Type = ArgType.Imm16, AiPos = true } }, OldNames = new[] { "memcpyToSpAi" } },
