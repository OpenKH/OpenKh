...
namespace OpenKh.Tools.Kh2MapCollisionEditor.ViewModels
{
    public class CollisionEditorViewModel : BaseNotifyPropertyChanged
    {
        ...
        public IEnumerable<System.Numerics.Vector4> C4 { get
            {
                if (Collisions == null) yield break;
                yield return Collisions.Vertex1;
                yield return Collisions.Vertex2;
                yield return Collisions.Vertex3;
                if (Collisions.Vertex4 != System.Numerics.Vector4.Zero)
                    yield return Collisions.Vertex4;
            } }
        ...
        public CoctLogical.CoctCollision Collisions { get => c3Item; set { c3Item = value; OnPropertyChanged(); OnPropertyChanged(nameof(C4)); } }
