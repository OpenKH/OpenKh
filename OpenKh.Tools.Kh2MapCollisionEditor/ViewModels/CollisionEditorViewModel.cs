...
namespace OpenKh.Tools.Kh2MapCollisionEditor.ViewModels
{
    public class CollisionEditorViewModel : BaseNotifyPropertyChanged
    {
        ...
        public IEnumerable<Coct.Co1> C1 => _coct?.Collision1;
        public IEnumerable<Coct.Co2> C2 => _coct?.Collision2;
        public IEnumerable<Coct.Co3> C3 => _coct?.Collision3;
        public IEnumerable<Coct.Vector4> C4 => _coct?.CollisionVertices;
        public IEnumerable<Coct.Co5> C5 => _coct?.Collision5;
        public IEnumerable<Coct.Co6> C6 => _coct?.Collision6;
        public IEnumerable<Coct.Co7> C7 => _coct?.Collision7;

        public Coct.Co1 C1Item { get => c1Item; set { c1Item = value; OnPropertyChanged(); } }
        public Coct.Co2 C2Item { get => c2Item; set { c2Item = value; OnPropertyChanged(); } }
