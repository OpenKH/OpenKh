...
namespace OpenKh.AssimpUtils
{
    public class AssimpGeneric
    {
        ...
        public static Matrix4x4 ToNumerics(Assimp.Matrix4x4 m) => new Matrix4x4(m.A1, m.A2, m.A3, m.A4, m.B1, m.B2, m.B3, m.B4, m.C1, m.C2, m.C3, m.C4, m.D1, m.D2, m.D3, m.D4);
        ...
        public static Assimp.Matrix4x4 GetNodeTransformMatrix(Vector3 scale, Vector3 quaternionRotation, Vector3 translation)
        {
            ...
            Assimp.Matrix4x4 rotation = Assimp.Matrix4x4.FromRotationX(quaternionRotation.X) *
                                        Assimp.Matrix4x4.FromRotationY(quaternionRotation.Y) *
                                        Assimp.Matrix4x4.FromRotationZ(quaternionRotation.Z);
