...
{
    public partial class InterfaceLayoutImporter : EditorImportPlugin
    {
        public enum Presets
        {
            Default,
        ...
        public override string _GetImporterName() => "InterfaceLayoutImporter";
        public override string _GetVisibleName() => "KH2 Interface Layout Importer";
        public override string[] _GetRecognizedExtensions() => ["2ld"];
        ...
        public override Error _Import(string sourceFile, string savePath, Dictionary options, Array<string> platformVariants, Array<string> genFiles)
        {
            ...
            var images = usesHdTextures ? Enumerable.Repeat((Texture2D)null, hdTextures.Max(i => i.Key) + 1).ToList() : [];
            ...
            var result = Converters.FromInterfaceLayout(barFile, images);
