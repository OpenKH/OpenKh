...
namespace OpenKh.Bbs
{
    public class Bbsa
    {
        ...
        private static Dictionary<string, int> PathsReverse =
        ...
        private class Header
        {
            ...
            [Data(Count = 15)] public Partition[] Partitions { get; set; }
        }
        ...
        private readonly Unknown[] _directories;
        private readonly Stream _stream;

        private Bbsa(Stream stream)
        {
            ...
            {
                stream.Position = _header.PartitionOffset + partition.Offset * LbaLength;
            ...
            _directories = Enumerable.Range(0, _header.FileDirectoryCount)
                    .Select(x => new Unknown
                    {
