...
namespace OpenKh.Kh2.Messages.Internals
{
    ...
    internal static class JapaneseTable
    {
        ...
        public static readonly char[] _table3 = new char[0x100]
        {
            ...
            '笑', '博', '輝', '畑', '宣', '況', '泥', '早', '演', '悩', '川', '弱', '係', '資', '張', '希', '非', '如', '迎', '軽', '暮', '派', '旅', '責', '督', '退', '縮', '頭',
        ...
        public static readonly char[] _table4 = new char[0x100]
        {
            ...
            '像', '打', '態', '彈', '珍', '投', '当', '內', '配', '白', '半', '費', '文', '枚', '在', '通', '特', '択', '動', '備', '武', '類', '覽', '技', '陸', '押', '換', '起',
            '经', '裝', '種', '殊', '作', '初', '主', '視', '員', '引', '泳', '活', '寄', '材', '全', '增', '速', '短', '倒', '落', '料', '形', '中', '表', '間', '敵', '來', '丘',
            '見', '橋', '黑', '原', '船', '長', '道', '秘', '闇', '数', '变', '化', '時', '高', '型', '段', '食', '登', '場', '賊', '入', '飛', '少', '最', '行', '回', '持', '成',
            '合', '手', '防', '御', '擊', '攻', '法', '耐', '久', '一', '度', '低', '超', '操', '縦', '性', '調', '整', '遠', '複', '機', '能', '追', '加','前', '方', '向', '部',
            '小', '定', '屋', '居', '隱', '奧', '遺', '暗', '安', '淵', '園', '胃',
        };

        public static readonly char[] _table5 = new char[0x100]
        {
            '江', '館', '犬', '客', '験', '穴', '会', '口', '窟', '広', '宮', '庫', '峽', '研', '究', '棺',
            '鬼', '計', '巻', '虛', '基', '果', '球', '界', '交', '休', '街', '議', '群', '岩', '月', '拷', '逆', '獄', '後', '所', '宿', '赤', '私', '室', '斎', '層', '草', '砂',
            '深', '倉', '集', '敷', '世', '息', '想', '女', '城', '蔵', '乗', '島', '竹', '滝', '通', '置', '底', '沈', '庭', '潮', '吊', '袋', '腸', '扉', '堂', '洞', '殿', '台',
            '沼', '難', '浜', '辺', '壁', '宝', '破', '腹', '氷', '拝', '噴', '崩', '番', '漠', '物', '墓', '密', '門', '默', '問', '遊', '谷', '離', '路', '裏', '綠', '廊', '楼',
            '牢', '礼', '巨', '樹', '意', '俺', '降', '壊', '今', '急', '光', '怪', '凶', '舵', '近', '確', '旗', '減', '画', '昇', '青', '左', '色', '捜', '先', '勝', '選', '受',
            '次', '丈', '点', '注', '他', '知', '体', '駄', '何', '吞', '返', '夫', '僕', '暴', '面', '目', '無', '待', '戾', '認', '電', '切', '完', '了', '保', '既', '可', '込',
