...
namespace OpenKh.Kh2.Messages.Internals
{
    internal class JapaneseSystemDecode : IMessageDecode
    {
        ...
        public static readonly char[] _table4 = new char[0x100]
        {
            ...
            '匹', '貓', '姬', '規', '失', '敗', '神', '箱', '兵', '教', '跡', '率', '組', '造', '_', '情',
            '多', '報', '分', '由', '立', '具', '星', '質', '流', '替', '役', '優', '雄', '連', '判', '斷',
            '共', '有', '工', '改', '考', '強', '好', '消', '求', '捨', '收', '順', '助', '身', '轉', '同',
            '渡', '錄', '的', '直', '運', '英', '距', '驚', '惠', '系', '効', '_', '三', '止', '字', '狀',
            '心', '振', '絕', '線', '像', '打', '態', '彈', '珍', '投', '当', '內', '配', '白', '半', '費',
            '文', '枚', '在', '通', '特', '_', '動', '備', '武', '類', '覽', '技', '陸', '押', '換', '起',
            '经', '裝', '種', '殊', '作', '初', '主', '視', '員', '引', '泳', '活', '寄', '材', '全', '增',
            '速', '短', '倒', '落', '料', '形', '中', '表', '間', '敵', '來', '丘', '見', '橋', '黑', '原',
            '船', '長', '道', '秘', '闇', '数', '变', '化', '時', '高', '型', '段', '食', '登', '場', '賊',
            '入', '飛', '少', '最', '行', '回', '持', '成', '合', '手', '防', '御', '擊', '攻', '法', '耐',
            '久', /*'一'*/'_', '度', '低', '超', '操', '_', '性', '調', '整', '遠', '複', '機', '能', '追', '加',
            '前', '方', '向', '部', '小', '定', '屋', '居', '隱', '奧', '遺', '暗', '安', '淵', '園', '胃',
        };

        public static readonly char[] _table5 = new char[0x100]
        {
            '江', '館', '犬', '客', '_', '穴', '会', '口', '窟', '広', '宮', '庫', '峽', '研', '究', '棺',
            '鬼', '計', '_', '虛', '基', '果', '球', '界', '交', '休', '街', '議', '群', '岩', '月', '拷',
            '逆', '獄', '後', '所', '宿', '赤', '私', '室', '斎', '層', '草', '砂', '深', '倉', '集', '敷',
            '世', '息', '想', '女', '城', '_', '_', '島', '竹', '_', '通', '置', '底', '沈', '庭', '潮',
            '吊', '袋', '腸', '扉', '堂', '洞', '殿', '台', '沼', '難', '_', '_', '壁', '_', '破', '腹',
            '_', '_', '噴', '崩', '番', '漠', '物', '墓', '密', '門', '默', '問', '遊', '谷', '離', '路',
            '裏', '綠', '廊', '楼', '牢', '礼', '巨', '樹', '意', '_', '降', '壊', '今', '急', '光', '怪',
            '凶', '舵', '近', '確', '旗', '減', '画', '昇', '青', '左', '色', '捜', '先', '勝', '選', '受',
            '次', '丈', '点', '注', '他', '知', '体', '駄', '何', '吞', '返', '夫', '僕', '暴', '面', '目',
            '無', '待', '戾', '認', '電', '切', '完', '了', '保', '既', '可', '_', '決', '新', '差', '商',
            '設', '削', '除', '獣', '值', '_', '仲', '品', '未', '_', '野', '右', '素', '個', '移', '位',
            '憶', '器', '更', '記', '期', '観', '級', '現', /*sys2-2*/'還', '題', '沒', '描', '令', '→', '←', '♪',
            '艦', '聖', '_', '龍', '忍', '苦', '評', '仕', '賢', '距', '&', '採', '?', '坑', '積', '夕',
            '_', '斬', '霸', /*'一'*/'_', '編', '語', '_', '理', '_', '央', '冠', '極', '烈', 'a', 'b', 'c',
